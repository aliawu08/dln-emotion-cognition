# Paper 2 (DLN series): Emotion–Cognition + Evidence Synthesis + Implementations

This repository contains **submission-ready manuscript files** and a complete set of **open-science deliverables** that implement the three-layer program described in the paper:
...
- **Word/APA submission:** `manuscript/Paper2_Emotion_Cognition_SubmissionReady.docx` (builds to `manuscript/Paper2_Emotion_Cognition_SubmissionReady.pdf`).
...
## Citation for the DLN computational paper (Paper 1)
